export class DataHelper {
    getRandomData(size, isInt = true, isUnique = false, begin = Number.MIN_SAFE_INTEGER, end = Number.MAX_SAFE_INTEGER) {
        let ans = {};
    ...
    getRandomNumber(begin = Number.MIN_SAFE_INTEGER, end = Number.MAX_SAFE_INTEGER, isInt = true, digit = 2) {
        return this.roundNumber(Math.random() * (end - begin + 1) + begin, isInt ? 0 : digit);
    }
    roundNumber(num, digit = 0) {
